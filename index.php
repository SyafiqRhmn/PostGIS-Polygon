...
<body>
  ...
  <script>
    ...
    var bigMarker = L.icon({
      iconUrl: 'https://cdn.icon-icons.com/icons2/822/PNG/512/marker_icon-icons.com_66468.png',
      iconSize: [20, 20],
      iconAnchor: [12, 12],
      popupAnchor: [1, -34],
      shadowSize: [41, 41],
    ...
    mymap.on('contextmenu', function(e) {
      ...
      if (index !== -1) {
        ...
        // Menghapus titik koordinat dari array coords dan mengupdate polygon
    ...
    $query = "SELECT ST_AsGeoJSON(geo) as geojson FROM polygon";
    ...
    while ($row = $result->fetch()) {
      ...
      if ($geometry->type == 'LineString') {
        ...
        // Menambahkan polygon ke dalam variabel layers sebagai layer yang terpisah-pisah
        $layers[] = "var layer$counter = L.polygon([" . implode(",", $polygon) . "], {color: 'red'}).addTo(mymap);";
        $counter++;
      }
    }
